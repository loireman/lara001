...
<div class="container">
    <div class="justify-content-center">
        ...
        @endif
        <div class="card">
            <div class="card-header">Create timetable
                <span class="float-right">
                    <a class="btn btn-primary" href="{{ route('timetables.index') }}">Timetables</a>
                </span>
            </div>
            <div class="card-body">
                {!! Form::open(array('route' => 'timetables.store', 'method'=>'POST')) !!}
                    ...
                    <button type="submit" class="btn bg-blue-600 btn-primary">Submit</button>
                {!! Form::close() !!}
            </div>
        </div>
    </div>
